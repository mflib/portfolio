...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const wasmFilePath = './CMPPortfolio-composeApp.wasm';
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./CMPPortfolio-composeApp.wasm',import.meta.url).href), importObject)).instance;
      }
    } catch (e) {
